...
| --- | --- | --- |
| matrix-sata-bluray | LG WH16NS60, SATA | Whole ASMedia controller `0000:03:00.0`, conditional on the complete safety gate and reviewed shutdown/apply. Not applied. |
